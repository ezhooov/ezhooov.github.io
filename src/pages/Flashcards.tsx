...
const verbs4 = {
  Петь: 'Ән айту',
  'Учить, изучать': 'Үйрену',
  Чинить: 'Жөндеу',
  Показывать: 'Көрсету',
  Знать: 'Білу',
  Резать: 'Кесу',
  Убирать: 'Жинау',
  'Играть в футбол': 'Футбол ойнау',
  'Играть на домбре': 'Домбыра ойнау'
} as const
...
const verbs5 = {
  ...
  Уносить: 'Әкету',
  Относить: 'Алып бару',
  Обижаться: 'Ренжу (искл.)',
  Волноваться: 'Қобалжу (искл.)',
  Обжигаться: 'Күю',
  Наливать: 'Құю',
  Прощать: 'Кешіру',
  Возвращаться: 'Қайту',
...
const verbs6 = {
  ...
  Отдыхать: 'Демалу',
  Пинать: 'Тебу',
  'Кататься на коньках': 'Коньки тебу',
  'Кататься на лыжах': 'Шаңғы тебу',
  'Кататься на велосипеде': 'Велосипед тебу',
  'Есть (1 слово)': 'Жеу',
  'Есть (2 слова)': 'Тамақ ішу',
  Спать: 'Ұйықтау'
}
...
const questionsVocabulary = {
  ...
  'Кому? К кому?': 'Кімге?',
  'Чему? К чему? Зачем? Почему? С какой целью?': 'Неге?',
